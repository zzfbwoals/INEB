...
/* audit_log — 감사 로그 페이지 (target 필터로 키별 조회) */
const AUDITS=[
 {id:1291,at:'2026-08-28 08:40:12',action:'KEY_TEST_ENCRYPT',target:'KEY #2',keyId:2,detail:'{"version":1,"result":"success"}'},
 {id:1290,at:'2026-08-27 18:30:00',action:'KEY_TEST_SIGN',target:'KEY #4',keyId:4,detail:'{"version":2,"result":"success"}'},
 {id:1289,at:'2026-08-27 14:02:18',action:'KEY_TEST_ENCRYPT',target:'KEY #1',keyId:1,detail:'{"version":3,"result":"success"}'},
 {id:1288,at:'2026-08-27 08:00:00',action:'KEY_TEST_DECRYPT',target:'KEY #7',keyId:7,detail:'{"version":1,"result":"fail","reason":"DEACTIVATED"}'},
 ...
 {id:1286,at:'2026-08-25 18:00:02',action:'KEY_STATUS_CHANGED',target:'KEY #6',keyId:6,detail:'{"action":"DEACTIVATE","scope":"KEY","reason":"연동 테스트 종료"}'},
 {id:1285,at:'2026-08-20 16:05:30',action:'KEY_ROTATED',target:'KEY #4',keyId:4,detail:'{"newVersion":3,"activationDate":"2026-09-01 00:00:00"}'},
 {id:1284,at:'2026-08-20 09:11:40',action:'KEY_TEST_DECRYPT',target:'KEY #1',keyId:1,detail:'{"version":2,"result":"success","note":"구 버전 복호화"}'},
 {id:1283,at:'2026-08-19 09:38:12',action:'LOGIN',target:'-',keyId:null,detail:'{"ip":"192.168.200.10","result":"success"}'},
 {id:1282,at:'2026-08-18 16:02:51',action:'USER_PLAIN_VIEW',target:'USER #103',keyId:null,detail:'{"reason":"CS 본인확인"}'},
 {id:1281,at:'2026-08-18 15:20:33',action:'KEY_UPDATED',target:'KEY #1',keyId:1,detail:'{"rotationPeriodDays":{"from":90,"to":180}}'},
 {id:1280,at:'2026-08-18 11:07:19',action:'NOTICE_CREATED',target:'NOTICE #12',keyId:null,detail:'{"files":2,"encrypted":true}'},
 {id:1279,at:'2026-08-17 18:31:44',action:'USER_UPDATED',target:'USER #104',keyId:null,detail:'{"status":"SUSPENDED","reEncrypted":true}'},
 ...
 {id:1277,at:'2026-07-28 11:20:44',action:'KEY_ROTATED',target:'KEY #1',keyId:1,detail:'{"newVersion":3,"activationDate":"2026-08-01 00:00:00"}'},
 {id:1276,at:'2026-07-01 10:00:00',action:'KEY_STATUS_CHANGED',target:'KEY #4',keyId:4,detail:'{"action":"DEACTIVATE","version":1,"reason":"재봉인 완료"}'},
];
const NOTICES=[
