import { isIntegrityViolation, type AuditLogItem } from '@/api/audit'
        ...
        <DialogBody>
          <div className="meta-box">
            <div className="kv-grid">
              ...
              <div className="k">행위</div><div><span className={`actchip${isIntegrityViolation(item.action) ? ' bad' : ''}`}>{item.action}</span></div>
